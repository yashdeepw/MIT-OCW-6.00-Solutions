...
def is_valid_word(word, hand, word_list):
    ...
    freq_word = get_frequency_dict(word)
    for i in freq_word:
        if ( hand.get(i,0) - freq_word[i] < 0 ):
            can_make_word = False
            break
        
    return ((word in word_list) and ( can_make_word ))
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while ( calculate_handlen(hand) != 0 ):
        ...
        if ( is_valid_word(word, hand, word_list) ):
            ...
            print
    print
    print 'Your total score:', total_score, 'points.'
    print
...
def play_game(word_list):
    ...
    * If the user inputs anything else, ask them again.
    ...
    while ( want != 'e' ):
        ...
        print '"r" to play the last hand again.'
        want = raw_input('"e" to exit game:')
        if (want == 'r'):
